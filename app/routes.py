        ...
        if (
            ...
            try:
                if User.query.filter_by(email=email).first() is not None:
                    return render_template("profile.html", error=True, message="Email already exists")
                ...
                print(exception)
                db.session.rollback()
                return render_template("profile.html", error=True, message="Something went wrong.Contact support")
    return render_template("profile.html", active_page="profile")
